...
<body>
    <form action="" method="POST" class="max-w-md mx-auto bg-neutral-900 p-6 rounded-lg mt-10">
        @csrf
        <label for="voornaam" class="block text-gray-700 font-bold mb-2">
            Voornaam
        </label>
        ...
        <label for="achternaam" class="block text-gray-700 font-bold mb-2">
            Achternaam
        </label>
