...
<body class="bg-yellow-50">
    <form action="/ingredienten" method="POST" class="max-w-md mx-auto bg-neutral-900 p-6 rounded-lg mt-10"
        method="POST">
        @csrf
        ...
        <input type="submit" value="Voeg nieuw ingredient toe"
            class="bg-green-800 text-yellow-50 py-2 px-4 mt-5 rounded">
    </form>
