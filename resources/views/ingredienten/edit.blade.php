...
<body class="bg-yellow-50">
    <form action="{{ url('ingredienten/' . $ingredient->id) }}"
        ...
        <div class="mb-4">
            ...
            <input type="text" id="name" name="name" value=" {{ $ingredient->name }} " placeholder="naam"
        ...
        <div class="mb-4">
            ...
            <input type="number" id="price" name="price" value=" {{ $ingredient->price }} " placeholder="prijs"
                class="border-black border rounded w-full py-2 px-3 bg-neutral-200">
        </div>
